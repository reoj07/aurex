...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <title>AURX Exchange Identity Verification</title>
    <script type="module" crossorigin src="./assets/main-B0iwJUKe.js"></script>
    ...
    <link rel="stylesheet" crossorigin href="./assets/main-DHCLZFEt.css">
  </head>
  <body data-static-route="/security/verification">
    <div id="root"></div>
  </body>
</html>
